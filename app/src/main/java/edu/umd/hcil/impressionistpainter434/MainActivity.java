...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuSquare:
                ...
                _impressionistView.setBrushType(BrushType.Square);
                return true;
            case R.id.menuVTrack:
                Toast.makeText(this, "VTracker Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.VTracker);
                return true;
        }
        return false;
    }
    ...
    public void onButtonClickSave(View v){
        MediaStore.Images.Media.insertImage(getContentResolver(), _impressionistView.getBitmap(), "Impressionist Drawing", "");
